...
# Contribute to Ory gemini-cli-extension<!-- omit in toc -->
...
_Please note_: We take Ory gemini-cli-extension's security and our users' trust very
seriously. If you believe you have found a security issue in Ory gemini-cli-extension,
...
[Ory gemini-cli-extension Discussions](https://github.com/orgs/ory/discussions) or the
[Ory Chat](https://www.ory.com/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/gemini-cli-extension/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory gemini-cli-extension?](#communication)
...
- I want to talk to other Ory gemini-cli-extension users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  gemini-cli-extension.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/gemini-cli-extension)

- I would like updates about new versions of Ory gemini-cli-extension.
  [How are new releases announced?](https://www.ory.com/l/sign-up-newsletter)

## How can I contribute?

The single most useful thing you can do is to
[open a well-written issue or discussion](https://github.com/ory/gemini-cli-extension/issues):
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory gemini-cli-extension.
...
- **Help with open issues.** We have a lot of open issues for Ory gemini-cli-extension and
...
Check out [Ory gemini-cli-extension Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory gemini-cli-extension,
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Conventional Commits configuration](https://github.com/ory/gemini-cli-extension/blob/master/.github/workflows/conventional_commits.yml)
...
[Contributor License Agreement](https://cla-assistant.io/ory/gemini-cli-extension).
...
maintain the quality and reliability of Ory gemini-cli-extension, please follow these
guidelines:
...
git clone git@github.com:ory/gemini-cli-extension.git
